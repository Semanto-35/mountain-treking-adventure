    ...
    <div>
      ...
      >
        <SwiperSlide>
          ...
          <div className="absolute top-1/3 left-20 md:left-32 md:w-1/2 space-y-2">
            ...
            <h2 className="text-3xl md:text-4xl font-semibold text-white animate__animated animate__fadeInUpBig animate__repeat-1	1">Mountain trekking offers breathtaking views, challenging terrain, and a rewarding connection with nature’s beauty</h2>
          </div>
        </SwiperSlide>
        <SwiperSlide>
